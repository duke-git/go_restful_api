...
replace golang.org/x/tools => github.com/golang/tools v0.0.0-20190719005602-e377ae9d6386
...
replace cloud.google.com/go => github.com/googleapis/google-cloud-go v0.43.0
